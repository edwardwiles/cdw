function importData(fakeData, DFake, seed)
    ...
    elseif fakeData == 3
        ...
        # filenames/location -- kept as a separate branch rather than overloading fakeData==0
        # since that branch's own files were never present on this server (untested path).
