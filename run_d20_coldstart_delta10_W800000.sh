...
LOG=sequential_gravity/coldstart_delta10_W800000_run.log
echo "=== Launch: $(date) ===" > "$LOG"

FAKEDATA=3 DVAL=20 DELTA_GRID=10.0 BOUND=upper PARALLEL_INVERSION=true WVAL=800000 \
...
touch sequential_gravity/coldstart_delta10_W800000_ALLDONE
