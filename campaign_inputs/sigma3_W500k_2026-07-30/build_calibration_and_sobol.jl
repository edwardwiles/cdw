...
include(joinpath(pwd(), "full_aod_diag", "d4_exact", "draw_design.jl"))   # unify-random-draw-production-pipeline 2026-07-30: also includes context_real_d20.jl + qmc_draws.jl transitively; qmc_context_real_d20.jl deleted (duplicated pipeline, see docs/DRAW_DESIGN_PIPELINE_CALL_GRAPH_2026-07-30.md)
