...
# test_verification_backend_default_cm.jl. See that file's header for what each check covers.
const D4X = @__DIR__
cd(D4X)
...
println("=== Real D=20/W=80,000 flexible-CM verification_backend gate (archC_verified_state, L=50) ===")
flush(stdout)
...
label = "flexible-CM D20/W=80000 L=$L"
