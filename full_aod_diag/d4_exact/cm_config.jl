...
function _cm_validate(cfg::CMConfig)
    ...
    cfg.marginal_restriction in (:common_flexible, :common_frechet) ||
        error("CMConfig: marginal_restriction must be :common_flexible or :common_frechet, got $(cfg.marginal_restriction)")
