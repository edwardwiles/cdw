# ================================================================================================
# True no-H operator bundle task, Part A.7: origin-ZC real D=20/W=100,000 equivalence gate.
# ================================================================================================
const _D4E = @__DIR__
...
layout = OriginByPowerLayout(ctx.D, 1, 0)
νfull0 = fill(1.0, ctx.D)
lp("Context built.")

println("="^90)
println("Origin-ZC D=20/W=100,000: operator-bundle (no H) vs dense-reference -- equivalence gate")
println("="^90)
...
println("="^90)
if isempty(FAILURES)
    println("ALL OPERATOR-VS-DENSE ORIGIN-ZC D=20/W=100000 EQUIVALENCE GATES PASSED")
else
