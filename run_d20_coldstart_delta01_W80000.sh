...
LOG=sequential_gravity/coldstart_delta01_W80000_run.log
echo "=== Launch: $(date) ===" > "$LOG"

FAKEDATA=3 DVAL=20 DELTA_GRID=0.1 BOUND=upper PARALLEL_INVERSION=true WVAL=80000 \
...
touch sequential_gravity/coldstart_delta01_W80000_ALLDONE
