...
LOG=sequential_gravity/coldstart_delta2_maxit3000_run.log
echo "=== Launch: $(date) ===" > "$LOG"

FAKEDATA=3 DVAL=20 DELTA_GRID=2.0 BOUND=upper PARALLEL_INVERSION=true \
  OUTER_OPT_FILE=$PERF/full_aod_diag/csw_outer_3000.opt \
...
touch sequential_gravity/coldstart_delta2_maxit3000_ALLDONE
